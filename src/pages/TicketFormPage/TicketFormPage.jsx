...
if (deleteTicket && !ticketDetail) return <h1>Loading</h1>    
    if (deleteTicket && ticketDetail)  return (<>
        <div className="page-header">
            <h1>Delete Ticket?</h1>
        </div>
        <h2>Are you sure you want to delete { ticketDetail.title }?</h2>
    ...
    if (createTicket || editTicket) return (<>
        <div className="page-header">
            {editTicket ? <h1>Edit {ticketDetail.title}'s Info</h1> : <h1>Add a Ticket</h1>}
        </div>
